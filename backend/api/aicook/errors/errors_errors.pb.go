...
func IsInvalidId(err error) bool {
	...
	e := errors.FromError(err)
	return e.Reason == ErrorReason_INVALID_ID.String() && e.Code == 400
}

func ErrorInvalidId(format string, args ...interface{}) *errors.Error {
	return errors.New(400, ErrorReason_INVALID_ID.String(), fmt.Sprintf(format, args...))
}
...
func IsUploadNotReady(err error) bool {
	if err == nil {
		return false
	}
	e := errors.FromError(err)
	return e.Reason == ErrorReason_UPLOAD_NOT_READY.String() && e.Code == 409
}

func ErrorUploadNotReady(format string, args ...interface{}) *errors.Error {
	return errors.New(409, ErrorReason_UPLOAD_NOT_READY.String(), fmt.Sprintf(format, args...))
}
