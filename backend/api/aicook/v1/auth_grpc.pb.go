...
const (
	...
	AuthService_WxLogin_FullMethodName          = "/aicook.v1.AuthService/WxLogin"
...
type AuthServiceClient interface {
	...
	WxLogin(ctx context.Context, in *WxLoginRequest, opts ...grpc.CallOption) (*AuthReply, error)
...
func (c *authServiceClient) WxLogin(ctx context.Context, in *WxLoginRequest, opts ...grpc.CallOption) (*AuthReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AuthReply)
...
func (UnimplementedAuthServiceServer) WxLogin(context.Context, *WxLoginRequest) (*AuthReply, error) {
