module github.com/chengjiang/aicook/backend

go 1.25.3

require (
	github.com/7as0nch/gocommon v0.1.2
	...
	github.com/cloudwego/eino-ext/components/document/transformer/splitter/recursive v0.0.0-20260409083444-42d9d11b55f4
